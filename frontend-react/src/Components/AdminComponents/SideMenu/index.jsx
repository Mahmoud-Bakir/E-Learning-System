...
export const SideMenu = ({display,handleParents,handleStudents,handleTeachers,handleAdd}) => {
  return (
    ...
    <div className=' flex column center nav-bg padding-35 width-15 self-center margin-20 circular-40 side-menu gap-50 white-text nav-text '>
         ...
         <button className="padding-15 white-bg circular-20 button-text"onClick={handleAdd}>Add User</button>
      </div>
  )
} 
